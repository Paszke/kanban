$(function() {
	...
	function Column(name) {
		...
		function createColumn() {
			...
			$columnAddCard.click(function() {
				self.addCard(new Card(prompt("Type your card name")));
			});
	...
	function Card(description) {
		...
		function createCard() {
			...
			var $cardDelete = $('<button>').addClass('btn-delete btn-color').text('Delete card');
	...
	$('.create-column')
		.click(function(){
		var name = prompt('Type your column name');
